...
public class MusicService {
	...
	private String getAccessToken() {
		try {
			System.out.println("clientId length = " + clientId.length());
			System.out.println("clientSecret length = " + clientSecret.length());
			System.out.println("clientId trim equals = " + clientId.equals(clientId.trim()));
			System.out.println("clientSecret trim equals = " + clientSecret.equals(clientSecret.trim()));
			...
			System.out.println("Spotify error = " + e);
			System.out.println("Spotify message = " + e.getMessage());
